				...
				<div class="col-xs-2 ">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div class="panel-collapse collapse in" id="personaBarra">
								<div class="panel-body">
									<li>agregar</li>
									<li>ver</li>
									<li>eliminar</li>
					...
					<div class="panel panel-default well">
						<ul class="nav nav-tabs ">
								 ...
								 <li><a href="#eliminar" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-remove"></span> Eliminar</a></li>
							...
							<div class="tab-pane fade" id="mostrar">
							  	<br>
							  		<ul class="list-group">
							  			...
							  			<li class="list-group-item">PERSONA 2</li>
							  			<li class="list-group-item">PERSONA 3</li>
							  			<li class="list-group-item">PERSONA 4</li>
							  			<li class="list-group-item">PERSONA 5</li>
									</ul>
							 </div>
